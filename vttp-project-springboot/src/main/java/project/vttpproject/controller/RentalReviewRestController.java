...
public class RentalReviewRestController {
    ...
    public ResponseEntity<String> saveReview(
            ...
            @RequestPart Integer propertyId,
            @RequestPart String title,
            @RequestPart String monthlyRentalCost,
            @RequestPart String floor,
            @RequestPart String apartmentFloorArea,
            @RequestPart String rentalFloorArea,
            @RequestPart String furnishings,
            @RequestPart Boolean sharedToilet,
            @RequestPart String rules,
            @RequestPart Date rentalStartDate,
            @RequestPart String rentalDuration,
            @RequestPart Integer occupants,
            @RequestPart BigDecimal rating,
